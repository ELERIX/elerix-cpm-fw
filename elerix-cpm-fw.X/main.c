...
u8_t MAXMINFLAG;
      ...
      #define DEBUG_CLOCK     LATB.F7
      #define DEBUG_DATA_OUT() TRISB7_bit = 0
      #define DEBUG_CLOCK_OUT() TRISB6_bit = 0 
      #define DEBUG_DATA    LATB.F6


       #define LED1_OUT()  TRISB0_bit=0
       #define LED1_IN()  TRISB0_bit=1
       #define LED1  LATB.F0

       #define LED2_OUT()  TRISD7_bit=0
       #define LED2_IN()  TRISD7_bit=1
       #define LED2  LATD.F7

       #define LED3_OUT()  TRISE3_bit=0
       #define LED3_IN()  TRISE3_bit=1
       #define LED3  LATE.F3

       #define LED4_OUT()  TRISE4_bit=0
       #define LED4  LATE.F4

       #define LED5_OUT()  TRISE5_bit=0
       #define LED5  LATE.F5

       #define LED6_OUT()  TRISE6_bit=0
       #define LED6  LATE.F6

       #define LED7_OUT()  TRISE7_bit=0
       #define LED7  LATE.F7

       #define LED8_OUT()  TRISD0_bit=0
       #define LED8  LATD.F0

       #define LED9_OUT()  TRISH2_bit=0
       #define LED9  LATH.F2

       #define LED10_OUT()  TRISH3_bit=0
       #define LED10  LATH.F3

       #define LED11_OUT()  TRISD1_bit=0
       #define LED11  LATD.F1

       #define LED12_OUT()  TRISD2_bit=0
       #define LED12  LATD.F2

       #define LED13_OUT()  TRISD3_bit=0
       #define LED13  LATD.F3

       #define LED14_OUT()  TRISD4_bit=0
       #define LED14  LATD.F4

       #define LED15_OUT()  TRISD5_bit=0
       #define LED15  LATD.F5

       #define LED16_OUT()  TRISD6_bit=0
       #define LED16  LATD.F6
       


//#define DUALLEDOK
#ifdef DUALLEDOK
       #define REDLED_OUT()  TRISE1_bit=0
       #define REDLED_IN()  TRISE1_bit=1
       #define REDLED  LATE.F1

       #define BLUELED_OUT()  TRISE0_bit=0
       #define BLUELED_IN()  TRISE0_bit=1
       #define BLUELED  LATE.F0


#else
       #define REDLED_OUT()  TRISE0_bit=0
       #define REDLED_IN()  TRISE0_bit=1
       #define REDLED  LATE.F0

       #define BLUELED_OUT()  TRISE1_bit=0
       #define BLUELED_IN()  TRISE1_bit=1
       #define BLUELED  LATE.F1

#endif

       #define PUSH     PORTC.F5
       #define PUSH_IN() TRISC5_bit = 1



       #define PWRUP       LATF.F4
       #define PWRUP_OUT() TRISF4_bit = 0
       #define PWRUP_IN()  TRISF4_bit = 1


       #define DIGIN1_IN()  TRISC2_bit=1
       #define DIGIN1       PORTC.F2

       #define DIGIN2_IN()  TRISB5_bit=1
       #define DIGIN2       PORTB.F5




       #define ADIN     PORTF.F0
       #define VOLTAGEPIN_IN() TRISF0_bit = 1
       #define VOLTAGEINPUT      0x28

       #define UMININ     PORTG.F7
       #define UMINPIN_IN() TRISG7_bit = 1
       #define UMININPUT       0x37

       #define UMIMAX     PORTF.F1
       #define UMAXPIN_IN() TRISF1_bit = 1
       #define UMAXINPUT      0x29


       #define DISA_OUT()  TRISB1_bit=0
       #define DISA  LATB.F1

       #define SELA0_OUT()  TRISC6_bit=0
       #define SELA0_IN()  TRISC6_bit=1
       #define SELA0  LATC.F6

       #define SELA1_OUT()  TRISC0_bit=0
       #define SELA1_IN()  TRISC0_bit=1
       #define SELA1  LATC.F0

       #define SELA2_OUT()  TRISC1_bit=0
       #define SELA2_IN()  TRISC1_bit=1
       #define SELA2  LATC.F1

       #define SELA3_OUT()  TRISA4_bit=0
       #define SELA3_IN()  TRISA4_bit=1
       #define SELA3  LATA.F4


       #define DISB_OUT()  TRISA2_bit=0
       #define DISB  LATA.F2

       #define SELB0_OUT()  TRISH0_bit=0
       #define SELB0_IN()  TRISH0_bit=1
       #define SELB0  LATH.F0

       #define SELB1_OUT()  TRISH1_bit=0
       #define SELB1_IN()  TRISH1_bit=1
       #define SELB1  LATH.F1

       #define SELB2_OUT()  TRISA0_bit=0
       #define SELB2_IN()  TRISA0_bit=1
       #define SELB2  LATA.F0

       #define SELB3_OUT()  TRISA1_bit=0
       #define SELB3_IN()  TRISA1_bit=1
       #define SELB3  LATA.F1



       #define DAC1_SDA_TRIS                TRISF3_bit
       #define DAC1_SDA_IN                  PORTF.F3
       #define DAC1_SDA_OUT                 LATF.F3
       
       #define DAC2_SDA_TRIS                TRISF2_bit
       #define DAC2_SDA_IN                  PORTF.F2
       #define DAC2_SDA_OUT                 LATF.F2

       #define DAC_SCL_TRIS                 TRISG6_bit
       #define DAC_SCL                      LATG.F6
       ...
       #define IQ_OUT()  TRISC7_bit=0
       #define IQPIN  LATC.F7


       #define UminP4_OUT()  TRISG0_bit=0
       #define UminP4_IN()  TRISG0_bit=1
       #define UminP4  LATG.F0
       #define UminP3_OUT()  TRISG1_bit=0
       #define UminP3_IN()  TRISG1_bit=1
       #define UminP3  LATG.F1
       #define UminP2_OUT()  TRISG2_bit=0
       #define UminP2_IN()  TRISG2_bit=1
       #define UminP2  LATG.F2
       #define UminP1_OUT()  TRISG3_bit=0
       #define UminP1_IN()  TRISG3_bit=1
       #define UminP1  LATG.F3

       #define UmaxP4_OUT()  TRISG4_bit=0
       #define UmaxP4_IN()  TRISG4_bit=1
       #define UmaxP4  LATG.F4
       #define UmaxP3_OUT()  TRISF7_bit=0
       #define UmaxP3_IN()  TRISF7_bit=1
       #define UmaxP3  LATF.F7
       #define UmaxP2_OUT()  TRISF6_bit=0
       #define UmaxP2_IN()  TRISF6_bit=1
       #define UmaxP2  LATF.F6
       #define UmaxP1_OUT()  TRISF5_bit=0
       #define UmaxP1_IN()  TRISF5_bit=1
       #define UmaxP1  LATF.F5

       #define UhavP3_OUT()  TRISB2_bit=0
       #define UhavP3_IN()  TRISB2_bit=1
       #define UhavP3  LATB.F2
       #define UhavP2_OUT()  TRISB3_bit=0
       #define UhavP2_IN()  TRISB3_bit=1
       #define UhavP2  LATB.F3
       #define UhavP1_OUT()  TRISB4_bit=0
       #define UhavP1_IN()  TRISB4_bit=1
       #define UhavP1  LATB.F4
...
void debug_print_strROM(const u8_t *s);
void debug_print_hex_u32(u32_t byte);
void debug_print_str(u8_t *s);
#endif
...
for (i=0; i<8; i++) {
                 DEBUG_CLOCK=0;
                 if (byte&0x01) {DEBUG_DATA=1;DEBUG_CLOCK=1; parita++;}
...
{
u8_t i,j,id,zero,sgn,nuly,OString[30];
u32_t exp;
u8_t temp;
u32_t ccast;
u32_t tccast,dccast;
         ...
         if (!i2cdatasekvence) {
             ...
             if (bitcnt<8) {
                 ...
                 bitcnt++;
                  ...
                  else if (i2cdatasekvence==2) {Lob(I2CREGVAL)=retval; CHK1=retval;}
                  else if (i2cdatasekvence==3) {Hib(I2CREGVAL)=retval; CHK2=retval;}
               ...
               if ((tempSDA!=SDA)) {
                              ...
                              if (SDA) {
                                 if (I2CWRITEFLAG) {
                                    ...
                                    if (I2CREGID==I2C_RUMINPOT) {UMIN_WR=1; }
                                    else if (I2CREGID==I2C_RUMAXPOT) {UMAX_WR=1; }
                              ...
                              else {i2cstatus=I2C_START_DETECTED;
                                    i2cdatasekvence=0;
                                    IOCCP.IOCCP3=1;
                                    bitcnt=0;
                                    I2CWRITEFLAG=0;
...
u8_t LD;
  ...
  LED1=0;  LED2=0;  LED3=0;  LED4=0;  LED5=0;  LED6=0;  LED7=0;  LED8=0;  LED9=0;  LED10=0;  LED11=0;  LED12=0;  LED13=0;  LED14=0;  LED15=0;  LED16=0;
  if ((LD>0) && (LD<17)) {
       if (LD==1) LED1=1;
       if (LD==2) LED2=1;
       if (LD==3) LED3=1;
...
void LED_poll()
{
   ...
   if (LED_stat[0]==BLUE) {LED1=1;LED1_OUT();fl=1;}
   ...
   BLUELED=1;BLUELED_OUT(); REDLED=0; REDLED_IN();
   delay_ms(4);
   BLUELED=0;
   ...
   REDLED=1;REDLED_OUT(); BLUELED=0;  BLUELED_IN();
   delay_ms(4);
   REDLED=0;
   REDLED_IN();
...
if (chn==1) {SELA3=0;SELA2=0;SELA1=0;SELA0=0;
             SELB3=0;SELB2=0;SELB1=0;SELB0=0;
             }
else
if (chn==2) {SELA3=0;SELA2=0;SELA1=0;SELA0=1;
             SELB3=0;SELB2=0;SELB1=0;SELB0=0;
             }
else
if (chn==3) {SELA3=0;SELA2=0;SELA1=0;SELA0=1;
             SELB3=0;SELB2=0;SELB1=0;SELB0=1;
             }
else
if (chn==4) {SELA3=0;SELA2=0;SELA1=1;SELA0=0;
             SELB3=0;SELB2=0;SELB1=0;SELB0=1;
             }
else
if (chn==5) {SELA3=0;SELA2=0;SELA1=1;SELA0=0;
             SELB3=0;SELB2=0;SELB1=1;SELB0=0;
             }
else
if (chn==6) {SELA3=0;SELA2=0;SELA1=1;SELA0=1;
             SELB3=0;SELB2=0;SELB1=1;SELB0=0;
             }
else
if (chn==7) {SELA3=0;SELA2=0;SELA1=1;SELA0=1;
             SELB3=0;SELB2=0;SELB1=1;SELB0=1;
             }
else
if (chn==8) {SELA3=0;SELA2=1;SELA1=0;SELA0=0;
             SELB3=0;SELB2=0;SELB1=1;SELB0=1;
             }
else
if (chn==9) {SELA3=0;SELA2=1;SELA1=0;SELA0=0;
             SELB3=0;SELB2=1;SELB1=0;SELB0=0;
             }
else
if (chn==10){SELA3=0;SELA2=1;SELA1=0;SELA0=1;
             SELB3=0;SELB2=1;SELB1=0;SELB0=0;
             }
else
if (chn==11){SELA3=0;SELA2=1;SELA1=0;SELA0=1;
             SELB3=0;SELB2=1;SELB1=0;SELB0=1;
             }
else
if (chn==12){SELA3=0;SELA2=1;SELA1=1;SELA0=0;
             SELB3=0;SELB2=1;SELB1=0;SELB0=1;
             }
else
if (chn==13){SELA3=0;SELA2=1;SELA1=1;SELA0=0;
             SELB3=0;SELB2=1;SELB1=1;SELB0=0;
             }
else
if (chn==14){SELA3=0;SELA2=1;SELA1=1;SELA0=1;
             SELB3=0;SELB2=1;SELB1=1;SELB0=0;
             }
else
if (chn==15){SELA3=0;SELA2=1;SELA1=1;SELA0=1;
             SELB3=0;SELB2=1;SELB1=1;SELB0=1;
             }
else
if (chn==16){SELA3=1;SELA2=0;SELA1=0;SELA0=0;
             SELB3=0;SELB2=1;SELB1=1;SELB0=1;
             }
...
if (chn==AGND_CHN){
             SELA3=1;SELA2=0;SELA1=0;SELA0=1;
             SELB3=1;SELB2=0;SELB1=0;SELB0=1;
             }

else
if (chn==VREF_CHN){
             SELA3=1;SELA2=0;SELA1=1;SELA0=0;
             SELB3=1;SELB2=0;SELB1=1;SELB0=0;
             }
...
{    u8_t odd=0;
     ...
     if (test>LIMITVOLTAGE) {
        ...
        if ( (test>=GB_Umin) && (test<=GB_Umax) ) temp_LED_stat[GB_chn-1]=OFF;
          ...
          if (test>=GB_Umax) {temp_LED_stat[GB_chn-1]=BLUE;
...
{ u8_t i;
  ...
  if (temp<0x0020) {GB_Umin=Umin0;GB_Uhavmin=Umin0-Uhavmindiff; MISSEDBUTTONFLAG=0; return 0;}
  else if ((temp>0x006E) && (temp<0x00AA)) {GB_Umin=Umin1; GB_Uhavmin=Umin1-Uhavmindiff; MISSEDBUTTONFLAG=0; return 1;}
  else if ((temp>0x00F0) && (temp<0x0168)) {GB_Umin=Umin2; GB_Uhavmin=Umin2-Uhavmindiff; MISSEDBUTTONFLAG=0; return 2;}
  else if ((temp>0x0180) && (temp<0x01E0)) {GB_Umin=Umin3; GB_Uhavmin=Umin3-Uhavmindiff; MISSEDBUTTONFLAG=0; return 3;}
  else if ((temp>0x0250) && (temp<0x02A0)) {GB_Umin=Umin4; GB_Uhavmin=Umin4-Uhavmindiff; MISSEDBUTTONFLAG=0; return 4;}
  else if ((temp>0x02C0) && (temp<0x0314)) {GB_Umin=Umin5; GB_Uhavmin=Umin5-Uhavmindiff; MISSEDBUTTONFLAG=0; return 5;}
  else if ((temp>0x0340) && (temp<0x0390)) {GB_Umin=Umin6; GB_Uhavmin=Umin6-Uhavmindiff; MISSEDBUTTONFLAG=0; return 6;}
  else if ((temp>0x03A9) && (temp<0x03F9)) {GB_Umin=Umin7; GB_Uhavmin=Umin7-Uhavmindiff; MISSEDBUTTONFLAG=0; return 7;}
  else  {
       MISSEDBUTTONFLAG=1;
       debug_print_str("\r\nUMINBUTERR:");
...
u8_t Umax_button()
{
  ...
  if (temp<0x0020) {GB_Umax=Umax0;GB_Uhavmax=Umax0+Uhavmaxdiff; MISSEDBUTTONFLAG=0; return 0;}
  else if ((temp>0x0170) && (temp<0x0180)) {GB_Umax=Umax1; GB_Uhavmax=Umax1+Uhavmaxdiff; MISSEDBUTTONFLAG=0; return 1;}
  else if ((temp>0x02E5) && (temp<0x0320)) {GB_Umax=Umax2; GB_Uhavmax=Umax2+Uhavmaxdiff; MISSEDBUTTONFLAG=0; return 2;}
  else if ((temp>0x03F0) && (temp<0x0420)) {GB_Umax=Umax3; GB_Uhavmax=Umax3+Uhavmaxdiff; MISSEDBUTTONFLAG=0; return 3;}
  else if ((temp>0x0570) && (temp<0x05B0)) {GB_Umax=Umax4; GB_Uhavmax=Umax4+Uhavmaxdiff; MISSEDBUTTONFLAG=0; return 4;}
  else if ((temp>0x0640) && (temp<0x0680)) {GB_Umax=Umax5; GB_Uhavmax=Umax5+Uhavmaxdiff; MISSEDBUTTONFLAG=0; return 5;}
  else if ((temp>0x0710) && (temp<0x0740)) {GB_Umax=Umax6; GB_Uhavmax=Umax6+Uhavmaxdiff; MISSEDBUTTONFLAG=0; return 6;}
  else if ((temp>0x07B0) && (temp<0x07DA)) {GB_Umax=Umax7; GB_Uhavmax=Umax7+Uhavmaxdiff; MISSEDBUTTONFLAG=0; return 7;}
  else  {
     MISSEDBUTTONFLAG=1;
     debug_print_str("\r\nUMAXBUTERR:");
     debug_print_hex_u16(temp);
    ...
    while (1)
    {
     ...
     if (cellconnectflag==1) {
      ...
      if (timeticks>testbuttontime) {
         ...
         CPMOUTPUTGETREG();
         if (UhavOKstatus==CELLUHAVFAIL) {CPMREGDATA[I2C_EVENTS]=CPMREGDATA[I2C_EVENTS]&~0x8000;}
         else if (UhavOKstatus==CELLUHAVOK) {CPMREGDATA[I2C_EVENTS]=CPMREGDATA[I2C_EVENTS]|0x8000;}
         if (UminOKstatus==CELLUMINFAIL) {CPMREGDATA[I2C_EVENTS]=CPMREGDATA[I2C_EVENTS]&~0x4000;}
         else if (UminOKstatus==CELLUMINOK) {CPMREGDATA[I2C_EVENTS]=CPMREGDATA[I2C_EVENTS]|0x4000;}
         if (UmaxOKstatus==CELLUMAXFAIL) {CPMREGDATA[I2C_EVENTS]=CPMREGDATA[I2C_EVENTS]&~0x2000;}
         else if (UmaxOKstatus==CELLUMAXOK) {CPMREGDATA[I2C_EVENTS]=CPMREGDATA[I2C_EVENTS]|0x2000;}
